...
class AppColors {
  ...
  static const _Palette _darkPalette = _Palette(
    ...
    glassGradient: LinearGradient(
      colors: [Color(0x1A00A859), Color(0x0DFFFFFF)],
  ...
  static const _Palette _lightPalette = _Palette(
    ...
    glassGradient: LinearGradient(
      colors: [Color(0x1400A859), Color(0x0DFFFFFF)],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    ),
  );
  ...
  static const Color primaryLight = Color(0xFF33C17E);
  static const Color primaryDark = Color(0xFF007A40);
  ...
  static const Color cardShadow = Color(0x1A00A859);
