...
class JambCbtApp extends StatefulWidget {
  const JambCbtApp({super.key});

  @override
  State<JambCbtApp> createState() => _JambCbtAppState();
}

class _JambCbtAppState extends State<JambCbtApp> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
